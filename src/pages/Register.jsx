...
import { registerUsersAction } from "./../redux/slices/users/usersSlices";
...
const Register = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (value) => {
      dispatch(registerUsersAction(value));
    },
            ...
            <div className="w-full lg:w-1/2 px-4">
              <div className="px-6 lg:px-20 py-12 lg:py-24 bg-gray-600 rounded-lg">
                ...
                <form onSubmit={formik.handleSubmit}>
                  <div className="mb-5 text-2xl text-white font-bold font-heading">
                    <div> Register Account</div>
                    <h3 className="  mt-3 text-base font-normal text-yellow-500 ">
                      If register takes too long, please refresh the page
                    </h3>
                  </div>
                  ...
                  <div className="flex items-center pl-6 mb-3 bg-white rounded-lg">
                    ...
                    <input
                      ...
                      className="w-full pl-4 pr-6 py-4 placeholder-gray-300 rounded-r-full focus:outline-none"
                      type="firstName"
                  ...
                  {loading ? (
                    ...
                    <button
                      type="submit"
                      className="py-3 w-full bg-blue-500 hover:bg-blue-600 text-white font-bold rounded-lg transition duration-200 outline-none"
                    >
                      Register
                    </button>
                  )}
                </form>
                <p className="text-white mt-5 tex-lg">
