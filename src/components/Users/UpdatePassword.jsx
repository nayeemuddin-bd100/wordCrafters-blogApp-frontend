...
import {changePasswordAction, resetChangePassAction} from "../../redux/slices/users/usersSlices"
...
const UpdatePassword = () => {
  ...
  const { updatedPassUser, changePassLoading, appErr, serverErr } = users;

  //redirect
  if (updatedPassUser) {
    dispatch(resetChangePassAction())
    return <Navigate to="/" />;
  }
  return (
