...
const ProfileCard = ({ id, image, title, category, date, view, author }) => {
  const isMobile = useMediaQuery({ maxWidth: 767 }); // Check if the screen width is less than or equal to 767px
        ...
        <div className="group">
          <div className="relative">
            ...
            <div className="absolute top-2 left-2 bg-white px-3 rounded-full  flex justify-center items-center flex-col py-3 group-hover:bg-red-400 group-hover:text-white duration-300 transition-all group-hover:ring-1 ring-white">
              ...
              <p className="text-xs text-gray-700  group-hover:text-white duration-300 transition-all">
          ...
          <div className="p-4 bg-white flex flex-col justify-between">
            <div className="mb-4">
              ...
              <Link
                to={`/posts/${id}`}
                className="text-lg font-bold hover:text-red-500 duration-300 transition-all "
              >
                {" "}
                <TextTruncate
                  line={2}
            ...
            <div className="flex items-center justify-between">
              <Link
                to={`/posts/${id}`}
                className="text-sm text-red-500 hover:text-red-400 transition-all duration-500"
              >
                View Details{" "}
                <span>
