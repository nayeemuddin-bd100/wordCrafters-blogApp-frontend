...
const AnotherPostCard = () => {
  ...
  return (
    <div className="flex items-center content-center gap-5 lg:gap-2 justify-start my-5 group">
     ...
     <div className="relative w-1/3 h-20 overflow-hidden rounded-lg">
      ...
      <div className="flex flex-col gap-1.5">
        <Link className="hover:text-indigo-700 transition-all duration-300">Lorem ipsum dolor sit, amet consectetur adipisicing elit.</Link>
